...
import { a_effectMetas } from '../let/a_effectMetas.js?v=119';
import { a_settingMetas } from '../let/a_settingMetas.js?v=119';
import { effectMeta_init } from '../core/effectMeta.js?v=119';
import { ui_capture_init } from '../core-ui/ui_capture.js?v=119';
import { ui_canvas_init } from '../core-ui/ui_canvas.js?v=119';
import { ui_render_size_init } from '../core-ui/ui_render.js?v=119';
import { store_name_restore, store_url_parse } from '../core/store_url_parse.js?v=119';
import { canvas_size_default } from '../core-ui/ui_canvas.js?v=119';
...
function setting_import(sete, index) {
  let url = './' + sete.import_path + '?v=119';
