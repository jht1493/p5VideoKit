...
homepage=COVID-19-Impact/nyc-covid-map
# homepage=COVID-19-Impact/brooklyn-covid-map
...
source=/Users/jht2/Documents/projects/_planning-repos/nyc-covid-map
...
# echo build_ver `cat ../gen/build/build_ver.txt`
